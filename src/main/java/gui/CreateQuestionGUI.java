...
public class CreateQuestionGUI extends JFrame {
	...
	public CreateQuestionGUI(Vector<domain.Event> v, boolean admin, boolean user, String userName) {
		try {
			jbInit(v, admin, user, userName);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}

	private void jbInit(Vector<domain.Event> v, boolean admin, boolean user, String userName) throws Exception {
